...
Este repositório contém a solução completa para o simulador de investimentos de CDB, dividida entre uma API robusta em **.NET 10** (com cobertura de testes unitários superior a 90% utilizando xUnit) e um ecossistema de Frontend moderno documentado via Storybook com suporte multiplas marcas/clientes e localizações.
...
dotnet build CdbInvestment.slnx
